...
// Grow is a factor the stylesheet wires for 1 through 4. A 0 is a
// spacer that cannot grow — a typo, since the typed layer defaults it
// to 1 — and a 5 is a factor no rule carries, which would silently
// render as 1. Both are refused with the reason.
